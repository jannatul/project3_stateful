...
class _BmiCalculatorState extends State<BmiCalculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  Container(   padding: EdgeInsets.all(8),color: Colors.blue, alignment: Alignment.center,
        child: Column(children: [Text('Enter Height in meter'),
          ...
          const Center(child:  ListTile( leading: Text('BMI Categories: ',),title:Text('Underweight = <18.5, Normal weight = 18.5–24.9') ,
